...
urlpatterns = [
    ...
    path('api/', include([
        ...
        path('check-bulk-availability/', views.api_check_bulk_availability, name='api_check_bulk_availability'),
        ...
        path('get-groups/', views.api_get_groups, name='api_get_groups'),
