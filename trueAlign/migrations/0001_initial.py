# Generated by Django 5.0.2 on 2025-04-30 04:47
...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.DateField(
                        blank=True,
                        null=True,
                        validators=[trueAlign.models.validate_future_date],
                ...
                (
                    "hire_date",
                    models.DateField(
                        blank=True, help_text="Date when offer was accepted", null=True
                    ),
                ),
                (
                    "start_date",
                    models.DateField(
                        blank=True, help_text="First day of work", null=True
                    ),
                ),
                (
                    "probation_end_date",
                ...
                (
                    "exit_date",
                    models.DateField(
                        blank=True, help_text="Last working day", null=True
                    ),
                ),
                (
                    "exit_reason",
                ...
                (
                    "rehire_eligibility",
                    models.BooleanField(
                        blank=True, help_text="Eligible for rehire", null=True
                    ),
                ),
                (
                    "salary_currency",
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=10,
                        null=True,
                        validators=[trueAlign.models.validate_pan],
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=12,
                        null=True,
                        validators=[trueAlign.models.validate_aadhar],
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["employment_status"], name="trueAlign_u_employm_5039f7_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="userdetails",
            index=models.Index(
                fields=["employee_type"], name="trueAlign_u_employe_bda06a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="userdetails",
            index=models.Index(
                fields=["work_location"], name="trueAlign_u_work_lo_30c0c8_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="userdetails",
            index=models.Index(
                fields=["hire_date"], name="trueAlign_u_hire_da_98da4c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="userdetails",
            index=models.Index(
                fields=["start_date"], name="trueAlign_u_start_d_f34b79_idx"
            ),
        ),
        migrations.AddIndex(
