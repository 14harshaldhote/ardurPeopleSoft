...
urlpatterns = [
    ...
    # API ENDPOINTS
    # ================================
    path('api/balance/', views.api_leave_balance, name='api_leave_balance'),
    path('api/balance/<int:user_id>/', views.api_leave_balance, name='api_user_leave_balance'),
    path('api/leave-types/', views.api_leave_types, name='api_leave_types'),
]
