...
class LeaveService:
    ...
    def apply_leave(user: User, leave_data: Dict) -> Tuple[LeaveRequest, Dict]:
        ...
        try:
            ...
            logger.error(f"Error applying leave for user {user.username}: {str(e)}")
    ...
    def approve_leave(leave_request: LeaveRequest, approver: User, comments: str = "") -> Dict:
        ...
        try:
            ...
            logger.error(f"Error approving leave {leave_request.id}: {str(e)}")
    ...
    def reject_leave(leave_request: LeaveRequest, approver: User, reason: str) -> Dict:
        ...
        try:
            ...
            logger.error(f"Error rejecting leave {leave_request.id}: {str(e)}")
    ...
    def cancel_leave(leave_request: LeaveRequest, user: User, reason: str = "") -> Dict:
        ...
        try:
            ...
            logger.error(f"Error cancelling leave {leave_request.id}: {str(e)}")
    ...
    def apply_comp_off(user: User, comp_off_data: Dict) -> Tuple[CompOffRequest, Dict]:
        ...
        try:
            ...
            logger.error(f"Error applying comp-off for user {user.username}: {str(e)}")
